...
bus_stop = {}
bus_s, bus_t, bus_f = set(), set(), set()
transfer = ('Elm Street', 'Sesame Street', 'Sunset Boulevard')
...
for json_dict in json_list:
    ...
    bus_stop.setdefault(bus_id, {'S': 0, 'T': 0, 'F': 0})
    ...
    if json_dict['stop_name'] in transfer:
        bus_stop[bus_id]['T'] += 1
        bus_t.update({json_dict['stop_name']})
